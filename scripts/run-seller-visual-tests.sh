...
# Script to run seller dashboard visual tests with Applitools Eyes
...
# Run the seller dashboard visual tests
echo "Running seller dashboard visual tests..."
npx cypress run --spec "cypress/e2e/visual-seller-dashboard.cy.ts"
