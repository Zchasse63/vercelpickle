...
# Script to run working visual tests with Applitools Eyes
...
# Run the working visual tests
echo "Running working visual tests..."
npx cypress run --spec "cypress/e2e/applitools-working.cy.ts"
