...
# Script to run user profile visual tests with Applitools Eyes
...
# Run the user profile visual tests
echo "Running user profile visual tests..."
npx cypress run --spec "cypress/e2e/visual-user-profile.cy.ts"
