...
# Script to run checkout flow visual tests with Applitools Eyes
...
# Run the checkout flow visual tests
echo "Running checkout flow visual tests..."
npx cypress run --spec "cypress/e2e/visual-checkout-flow.cy.ts"
