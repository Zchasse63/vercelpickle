...
# Script to run robust visual test with Applitools Eyes
...
# Run the robust visual test
echo "Running robust visual test..."
npx cypress run --spec "cypress/e2e/applitools-robust.cy.ts"
