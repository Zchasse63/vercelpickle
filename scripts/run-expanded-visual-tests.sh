...
# Script to run expanded visual tests with Applitools Eyes
...
npx cypress run --spec "cypress/e2e/visual-responsive.cy.ts"

# Run the interaction tests
echo "Running interaction tests..."
npx cypress run --spec "cypress/e2e/visual-interactions.cy.ts"
