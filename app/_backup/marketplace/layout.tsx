...
export default function MarketplaceLayout({
  ...
  if (typeof window === "undefined" || !convexClient) {
    return (
      <div className="flex min-h-screen flex-col" data-testid="marketplace-layout" data-cy="marketplace-layout">
        <MarketplaceHeader />
        <main className="flex-1 bg-gradient-to-b from-[#F1E5C3]/20 to-white relative" data-testid="marketplace-content" data-cy="marketplace-content">
