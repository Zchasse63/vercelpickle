...
import {
  ...
  preloadSellerRevenueChart,
  preloadSellerRecentOrders,
  preloadSellerTopProducts,
  preloadSellerInventoryAlert
} from "@/components/seller/lazy-seller-components"
...
export default function SellerDashboardClient() {
  ...
  useEffect(() => {
    if (activeTab === "overview") {
      // Preload all overview components
      preloadSellerRevenueChart()
      preloadSellerRecentOrders()
      preloadSellerTopProducts()
      preloadSellerInventoryAlert()
  ...
  return (
    <main className="flex flex-col gap-4 w-full max-w-full" data-testid="seller-dashboard">
      ...
      <Tabs 
        ...
        className="space-y-4 animate-fade-up delay-100 w-full"
